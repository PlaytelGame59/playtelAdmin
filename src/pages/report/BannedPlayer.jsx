...
import { getPlayerData, getbannedPlayerData } from "../../api/Api";
...
const BannedPlayers = () => {
    ...
    const mainPlayerData = async () => {
        try {
            setLoading(true)
            const data = await getbannedPlayerData(currentPage, pageSize);
            if(data) {
                setplayerData(data);
                setSearchClicked(false);
            }
                                ...
                                <Row>
                                    <Breadcrumb
                                        items={[
                                            ...
                                            {
                                                title: <a href="/report/bannedPlayers">Banned Player Report</a>,
                                            }, 
                                            // {
