...
import { getPlayerData, getrejectedWithdrawData } from "../../api/Api";
...
const RejectTransaction = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "rejectedAt",
            // ...getColumnSearchProps("rejectedAt")
        },
        {
            title: "Requested By",
    ...
    const mainPlayerData = async () => {
        try {
            setLoading(true)
            const data = await getrejectedWithdrawData();
            if(data) {
                setplayerData(data);
            }
        } catch (error) {
                    ...
                    >
                        <Row>
                            ...
                            >
                                ...
                                <hr />
                                <p>Rejected Transaction History </p>
                                    ...
                                    <Table 
                                        ...
                                        expandable={{
                                            expandedRowRender: (record) => (
                                                <>
                                                    <p style={{ margin: 0 }}>Ifsc Code {record.ifscCode}</p>
